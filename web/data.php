...
class DataSource
{ 
	var $server   = "aa3f3k3e04tw8h.cmygdl0of15n.us-west-2.rds.amazonaws.com"; //database server 
	var $user     = "arcameli"; //database login name 
	var $pass     = "Kameleon13"; //database login password 
	var $database = "ebdb"; //database name 
